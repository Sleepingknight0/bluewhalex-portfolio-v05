...
| --------------------------------- | ------------------------------------- | ------------------------------------ | -------------------------------------------------------------------------------------------------------------------- |
| **NACC Overnight Parking Log**    | Operational system · In service       | Python, Streamlit, Google Sheets     | Private — links intentionally withheld                                                                                |
| **NACC Parking Request Platform** | Workflow platform · In service        | TypeScript, Next.js, React, Supabase | Private — links intentionally withheld                                                                                |
